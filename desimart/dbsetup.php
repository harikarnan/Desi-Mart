...
$sqlInsertProducts = "INSERT INTO products (name, category_id, price, products_image_path, description) VALUES

    ('Premium Basmati Rice', 1, 12.99, 
    ...
    ('Handcrafted Clay Cookware Set', 6, 26.99,  
    ...
    ('Kashmiri Red Chili Powder', 2, 4.99, 
...
// Insert sample users
$sqlInsertUsers = "INSERT INTO users (name, email, password, role) VALUES
